...
def export_prediction_from_logits(predicted_array_or_file: Union[np.ndarray, torch.Tensor], properties_dict: dict,
    ...
    if save_probabilities:
        ...
        print(f'shape of prob_final: {probabilities_final.shape}')
        probabilities_final = label_manager.downsample_probabilities(probabilities_final) #$ downsampling probabilities with factor 16
